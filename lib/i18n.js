...
const TRANSLATIONS = {
  fr: {
    ...
    "shell.language.fr": "Français",
    "shell.language.en": "Anglais",
    ...
    "loading.sub":
      "Le calendrier est chargé en temps réel depuis Google Calendar. Cela peut prendre quelques secondes, jusqu'à 2 minutes.",
...
/**
 * Resolves an explicit URL locale before falling back to the browser header.
 */
function resolveLocale(req) {
  const requested = typeof req.query.lang === "string" ? req.query.lang.toLowerCase() : "";
  return requested === "fr" || requested === "en" ? requested : detectLocale(req);
}
